class PriorityQueue {
    ...
    findIndexByPriority(priority) {
        const highestPriorityIndex = this.internalQueue.findIndex(i => i.priority === priority)
    ...
    dequeue() {
        ...
        if(highestPriority) {
            ...
            const {element: dequeuedElement} = this.internalQueue[highestPriorityIndex]
            const newQueue = [...this.internalQueue.slice(0, highestPriorityIndex), ...this.internalQueue.slice(highestPriorityIndex + 1)]
